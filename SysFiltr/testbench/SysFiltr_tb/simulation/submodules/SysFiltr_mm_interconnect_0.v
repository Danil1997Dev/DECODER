...
`timescale 1 ps / 1 ps
module SysFiltr_mm_interconnect_0 (
		input  wire        clk_0_clk_clk,                                  //                                clk_0_clk.clk
		input  wire        cpu_reset_reset_bridge_in_reset_reset,          //          cpu_reset_reset_bridge_in_reset.reset
		input  wire        decoder_reset_sink_reset_bridge_in_reset_reset, // decoder_reset_sink_reset_bridge_in_reset.reset
		...
		output wire [4:0]  decoder_avalon_slave_address,                   //                     decoder_avalon_slave.address
		output wire        decoder_avalon_slave_write,                     //                                         .write
		output wire [31:0] decoder_avalon_slave_writedata,                 //                                         .writedata
		...
		output wire [14:0] ram_s2_address,                                 //                                   ram_s2.address
	...
	wire  [31:0] decoder_avalon_slave_agent_m0_readdata;                                    // decoder_avalon_slave_translator:uav_readdata -> decoder_avalon_slave_agent:m0_readdata
	wire         decoder_avalon_slave_agent_m0_waitrequest;                                 // decoder_avalon_slave_translator:uav_waitrequest -> decoder_avalon_slave_agent:m0_waitrequest
	wire         decoder_avalon_slave_agent_m0_debugaccess;                                 // decoder_avalon_slave_agent:m0_debugaccess -> decoder_avalon_slave_translator:uav_debugaccess
	wire  [17:0] decoder_avalon_slave_agent_m0_address;                                     // decoder_avalon_slave_agent:m0_address -> decoder_avalon_slave_translator:uav_address
	wire   [3:0] decoder_avalon_slave_agent_m0_byteenable;                                  // decoder_avalon_slave_agent:m0_byteenable -> decoder_avalon_slave_translator:uav_byteenable
	wire         decoder_avalon_slave_agent_m0_read;                                        // decoder_avalon_slave_agent:m0_read -> decoder_avalon_slave_translator:uav_read
	wire         decoder_avalon_slave_agent_m0_readdatavalid;                               // decoder_avalon_slave_translator:uav_readdatavalid -> decoder_avalon_slave_agent:m0_readdatavalid
	wire         decoder_avalon_slave_agent_m0_lock;                                        // decoder_avalon_slave_agent:m0_lock -> decoder_avalon_slave_translator:uav_lock
	wire  [31:0] decoder_avalon_slave_agent_m0_writedata;                                   // decoder_avalon_slave_agent:m0_writedata -> decoder_avalon_slave_translator:uav_writedata
	wire         decoder_avalon_slave_agent_m0_write;                                       // decoder_avalon_slave_agent:m0_write -> decoder_avalon_slave_translator:uav_write
	wire   [2:0] decoder_avalon_slave_agent_m0_burstcount;                                  // decoder_avalon_slave_agent:m0_burstcount -> decoder_avalon_slave_translator:uav_burstcount
	wire         decoder_avalon_slave_agent_rf_source_valid;                                // decoder_avalon_slave_agent:rf_source_valid -> decoder_avalon_slave_agent_rsp_fifo:in_valid
	wire  [92:0] decoder_avalon_slave_agent_rf_source_data;                                 // decoder_avalon_slave_agent:rf_source_data -> decoder_avalon_slave_agent_rsp_fifo:in_data
	wire         decoder_avalon_slave_agent_rf_source_ready;                                // decoder_avalon_slave_agent_rsp_fifo:in_ready -> decoder_avalon_slave_agent:rf_source_ready
	wire         decoder_avalon_slave_agent_rf_source_startofpacket;                        // decoder_avalon_slave_agent:rf_source_startofpacket -> decoder_avalon_slave_agent_rsp_fifo:in_startofpacket
	wire         decoder_avalon_slave_agent_rf_source_endofpacket;                          // decoder_avalon_slave_agent:rf_source_endofpacket -> decoder_avalon_slave_agent_rsp_fifo:in_endofpacket
	wire         decoder_avalon_slave_agent_rsp_fifo_out_valid;                             // decoder_avalon_slave_agent_rsp_fifo:out_valid -> decoder_avalon_slave_agent:rf_sink_valid
	wire  [92:0] decoder_avalon_slave_agent_rsp_fifo_out_data;                              // decoder_avalon_slave_agent_rsp_fifo:out_data -> decoder_avalon_slave_agent:rf_sink_data
	wire         decoder_avalon_slave_agent_rsp_fifo_out_ready;                             // decoder_avalon_slave_agent:rf_sink_ready -> decoder_avalon_slave_agent_rsp_fifo:out_ready
	wire         decoder_avalon_slave_agent_rsp_fifo_out_startofpacket;                     // decoder_avalon_slave_agent_rsp_fifo:out_startofpacket -> decoder_avalon_slave_agent:rf_sink_startofpacket
	wire         decoder_avalon_slave_agent_rsp_fifo_out_endofpacket;                       // decoder_avalon_slave_agent_rsp_fifo:out_endofpacket -> decoder_avalon_slave_agent:rf_sink_endofpacket
	wire         cmd_mux_src_valid;                                                         // cmd_mux:src_valid -> decoder_avalon_slave_agent:cp_valid
	wire  [91:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> decoder_avalon_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                         // decoder_avalon_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [3:0] cmd_mux_src_channel;                                                       // cmd_mux:src_channel -> decoder_avalon_slave_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                                 // cmd_mux:src_startofpacket -> decoder_avalon_slave_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                                   // cmd_mux:src_endofpacket -> decoder_avalon_slave_agent:cp_endofpacket
	...
	wire  [17:0] ram_s2_agent_m0_address;                                                   // ram_s2_agent:m0_address -> ram_s2_translator:uav_address
	...
	wire  [92:0] ram_s2_agent_rf_source_data;                                               // ram_s2_agent:rf_source_data -> ram_s2_agent_rsp_fifo:in_data
	...
	wire  [92:0] ram_s2_agent_rsp_fifo_out_data;                                            // ram_s2_agent_rsp_fifo:out_data -> ram_s2_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                     // cmd_mux_003:src_valid -> ram_s2_agent:cp_valid
	wire  [91:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> ram_s2_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                     // ram_s2_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [3:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> ram_s2_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                             // cmd_mux_003:src_startofpacket -> ram_s2_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                               // cmd_mux_003:src_endofpacket -> ram_s2_agent:cp_endofpacket
	...
	wire         decoder_avalon_slave_agent_rp_valid;                                       // decoder_avalon_slave_agent:rp_valid -> router_002:sink_valid
	wire  [91:0] decoder_avalon_slave_agent_rp_data;                                        // decoder_avalon_slave_agent:rp_data -> router_002:sink_data
	wire         decoder_avalon_slave_agent_rp_ready;                                       // router_002:sink_ready -> decoder_avalon_slave_agent:rp_ready
	wire         decoder_avalon_slave_agent_rp_startofpacket;                               // decoder_avalon_slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         decoder_avalon_slave_agent_rp_endofpacket;                                 // decoder_avalon_slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire         ram_s2_agent_rp_valid;                                                     // ram_s2_agent:rp_valid -> router_005:sink_valid
	wire  [91:0] ram_s2_agent_rp_data;                                                      // ram_s2_agent:rp_data -> router_005:sink_data
	wire         ram_s2_agent_rp_ready;                                                     // router_005:sink_ready -> ram_s2_agent:rp_ready
	wire         ram_s2_agent_rp_startofpacket;                                             // ram_s2_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         ram_s2_agent_rp_endofpacket;                                               // ram_s2_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         decoder_avalon_slave_agent_rdata_fifo_src_valid;                           // decoder_avalon_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] decoder_avalon_slave_agent_rdata_fifo_src_data;                            // decoder_avalon_slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         decoder_avalon_slave_agent_rdata_fifo_src_ready;                           // avalon_st_adapter:in_0_ready -> decoder_avalon_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                             // avalon_st_adapter:out_0_valid -> decoder_avalon_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                              // avalon_st_adapter:out_0_data -> decoder_avalon_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                             // decoder_avalon_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                             // avalon_st_adapter:out_0_error -> decoder_avalon_slave_agent:rdata_fifo_sink_error
	...
	wire         ram_s2_agent_rdata_fifo_src_valid;                                         // ram_s2_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] ram_s2_agent_rdata_fifo_src_data;                                          // ram_s2_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         ram_s2_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_003:in_0_ready -> ram_s2_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                         // avalon_st_adapter_003:out_0_valid -> ram_s2_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                          // avalon_st_adapter_003:out_0_data -> ram_s2_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                         // ram_s2_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                         // avalon_st_adapter_003:out_0_error -> ram_s2_agent:rdata_fifo_sink_error
	...
	) decoder_avalon_slave_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (decoder_reset_sink_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (decoder_avalon_slave_agent_m0_address),          // avalon_universal_slave_0.address
		.uav_burstcount         (decoder_avalon_slave_agent_m0_burstcount),       //                         .burstcount
		.uav_read               (decoder_avalon_slave_agent_m0_read),             //                         .read
		.uav_write              (decoder_avalon_slave_agent_m0_write),            //                         .write
		.uav_waitrequest        (decoder_avalon_slave_agent_m0_waitrequest),      //                         .waitrequest
		.uav_readdatavalid      (decoder_avalon_slave_agent_m0_readdatavalid),    //                         .readdatavalid
		.uav_byteenable         (decoder_avalon_slave_agent_m0_byteenable),       //                         .byteenable
		.uav_readdata           (decoder_avalon_slave_agent_m0_readdata),         //                         .readdata
		.uav_writedata          (decoder_avalon_slave_agent_m0_writedata),        //                         .writedata
		.uav_lock               (decoder_avalon_slave_agent_m0_lock),             //                         .lock
		.uav_debugaccess        (decoder_avalon_slave_agent_m0_debugaccess),      //                         .debugaccess
		.av_address             (decoder_avalon_slave_address),                   //      avalon_anti_slave_0.address
		.av_write               (decoder_avalon_slave_write),                     //                         .write
		.av_writedata           (decoder_avalon_slave_writedata),                 //                         .writedata
		.av_read                (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) decoder_avalon_slave_agent (
		.clk                     (clk_0_clk_clk),                                         //             clk.clk
		.reset                   (decoder_reset_sink_reset_bridge_in_reset_reset),        //       clk_reset.reset
		.m0_address              (decoder_avalon_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (decoder_avalon_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (decoder_avalon_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (decoder_avalon_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (decoder_avalon_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (decoder_avalon_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (decoder_avalon_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (decoder_avalon_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (decoder_avalon_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (decoder_avalon_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (decoder_avalon_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (decoder_avalon_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (decoder_avalon_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (decoder_avalon_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (decoder_avalon_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (decoder_avalon_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (decoder_avalon_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (decoder_avalon_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (decoder_avalon_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (decoder_avalon_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (decoder_avalon_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (decoder_avalon_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (decoder_avalon_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (decoder_avalon_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (decoder_avalon_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (decoder_avalon_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                         // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                         //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                          //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                         //                .error
		.rdata_fifo_src_ready    (decoder_avalon_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (decoder_avalon_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (decoder_avalon_slave_agent_rdata_fifo_src_data),        //                .data
	...
	) decoder_avalon_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                         //       clk.clk
		.reset             (decoder_reset_sink_reset_bridge_in_reset_reset),        // clk_reset.reset
		.in_data           (decoder_avalon_slave_agent_rf_source_data),             //        in.data
		.in_valid          (decoder_avalon_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (decoder_avalon_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (decoder_avalon_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (decoder_avalon_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (decoder_avalon_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (decoder_avalon_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (decoder_avalon_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (decoder_avalon_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (decoder_avalon_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	SysFiltr_mm_interconnect_0_router router (
	...
	SysFiltr_mm_interconnect_0_router_001 router_001 (
	...
	SysFiltr_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (decoder_avalon_slave_agent_rp_ready),            //      sink.ready
		.sink_valid         (decoder_avalon_slave_agent_rp_valid),            //          .valid
		.sink_data          (decoder_avalon_slave_agent_rp_data),             //          .data
		.sink_startofpacket (decoder_avalon_slave_agent_rp_startofpacket),    //          .startofpacket
		.sink_endofpacket   (decoder_avalon_slave_agent_rp_endofpacket),      //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (decoder_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SysFiltr_mm_interconnect_0_router_003 router_003 (
	...
	SysFiltr_mm_interconnect_0_router_002 router_004 (
	...
	SysFiltr_mm_interconnect_0_router_005 router_005 (
	...
	SysFiltr_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SysFiltr_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SysFiltr_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (decoder_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SysFiltr_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SysFiltr_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SysFiltr_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SysFiltr_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (decoder_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SysFiltr_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SysFiltr_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SysFiltr_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SysFiltr_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SysFiltr_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SysFiltr_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
		...
		.in_rst_0_reset (decoder_reset_sink_reset_bridge_in_reset_reset),  // in_rst_0.reset
		.in_0_data      (decoder_avalon_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (decoder_avalon_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (decoder_avalon_slave_agent_rdata_fifo_src_ready), //         .ready
